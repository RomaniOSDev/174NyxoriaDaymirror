...
import SwiftUI
    ...
    public class NyxoriaDaymirrorSceneController: UIViewController,
        ...
        public func TestGraphQLUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if NyxoriaDaymirrorManager.shared.TestGraphQLUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                NyxoriaDaymirrorManager.shared.TestGraphQLUpdateManagerFinal = finalUrl
        ...
        public func TestGraphQLUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func TestGraphQLUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func TestGraphQLUpdateManagerToggleNavBar() {
