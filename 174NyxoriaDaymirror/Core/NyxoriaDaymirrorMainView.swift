...
struct NyxoriaDaymirrorMainView: View {
    ...
    var body: some View {
        Group {
            if requestNotifications {
                NyxoriaDaymirrorLoadingView()
            } else {
                if somethingWentWrong {
                    Text("")
                    NyxoriaDaymirrorManager.NyxoriaDaymirrorUpdateManagerUI(NyxoriaDaymirrorUpdateManagerInfo: supportMessage)
                        .ignoresSafeArea()
                } else {
                    ContentView()
                }
